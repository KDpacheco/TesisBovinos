        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="código_madre" class="form-control" data-toggle="tooltip" data-placement="top"
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <select name="código_padre" class="form-control" data-toggle="tooltip" data-placement="top"
